      ...
      <template v-else>
        ...
        <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div
            ...
            :key="asset.id"
            class="bg-white border border-gray-200 rounded-lg overflow-hidden cursor-pointer hover:shadow-md transition-shadow flex flex-col"
          ...
          >
            ...
            <div
              v-else
              class="w-full h-44 bg-gray-100 flex items-center justify-center flex-shrink-0"
            >
            ...
            <div class="px-4 pb-5 pt-3 flex flex-col flex-1">
              <div class="flex items-start justify-between mb-2">
                ...
                <span class="text-xs font-medium bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full ml-2 flex-shrink-0">{{ asset.type }}</span>
              </div>
              <p class="text-lg font-bold text-primary-600 mt-auto">
